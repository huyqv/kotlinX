 ...
 * -------------------------------------------------------------------------------------------------
 */
class InputViewIcon : FrameLayout {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        try {
            ...
            LayoutInflater.from(context).inflate(R.layout.widget_input_icon, this)
            isClickable = true
    ...
    private fun configDrawable(types: TypedArray) {
        ...
        val drawable = types.getResourceId(R.styleable.InputView_android_drawable, 0)
        if (drawable != 0) {
            inputImageViewDrawable.setImageResource(drawable)
            inputImageViewDrawable.setColorFilter(color)
        }
    }
