...
import com.sample.library.extension.androidId
import com.sample.library.extension.packageName
...
object KeyStoreImp {
    ...
    private val keyPairGenerator: KeyPairGenerator get() = KeyPairGenerator.getInstance(keyProperties, provider)

    private val algorithmParameterSpec: AlgorithmParameterSpec
        get() {
            return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                KeyGenParameterSpec.Builder(aliasKeyStore,
